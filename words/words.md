...
Por supuesto, no hay que hacer acopio de papel higiénico, pero si los responsables públicos tienen miedo al miedo solamente tenderán a minimizar los peligros reales para evitar la «histeria colectiva». El problema no es el miedo, sino el cómo *canalizamos* nuestro miedo. El miedo nos permite prepararnos y fortalecernos para enfrentar los peligros actuales y futuros.

Sinceramente, estamos preocupados. ¡Y pensamos que seguramente tú también lo estás! Por eso, para ayudar a canalizar nuestro miedo de la mejor manera, traemos a tí estas **simulaciones interactivas**, para que *tú* puedas canalizar tu miedo a través de la comprensión:
...
El objetivo de esta guía es darte esperanza *y* tal vez, por qué no... miedo. Para ganar al COVID-19 **de una forma que también proteja nuestra salud mental y financiera**, necesitamos optimismo para crear planes y pesimismo para crear planes de contingencia. *«El optimismo inventa el avión y el pesimismo, el paracaídas».*

[^timestamp]: Estas notas al pie de página mostrarán fuentes, enlaces y comentarios extra. ¡Como este comentario!
    
Si bien es cierto que muchos de los detalles de éste contenido caducarán eventualmente (por el avance de la temporalidad), estamos seguros de que la cubre el 95% de los futuros posibles, y que la introducción a la epidemiología será un recurso útil que perdurará.
...
Se estima que, *al comienzo* de un brote del COVID-19, el virus salta de una <icon i></icon> a una <icon s></icon> cada 4 días, *en promedio*.[^serial_interval] (Recuerda que hay mucha variabilidad).
...
Si simulamos que se «duplique cada cada 4 días» *y nada más*, en una población que al comienzo sólo tiene 0.001% <icon i></icon>, ¿qué pasa?
...
Esta es la **curva de crecimiento exponencial.** Comienza plana y en determinado momento explota y pasa de ser un «ah, es cómo la gripe» a un «ah claro, la gripe no crea *fosas comunes en ciudades desarrolladas*».
...
Con el COVID-19, se estima que eres <icon i></icon> Infeccioso durante 10 días, *en promedio*.[^infectiousness] Eso significa que algunas personas se recuperan antes de 10 días y otras después. **Aquí se ve cómo es éso, con una simulación que *comienza* con un 100% de <icon i></icon>:**
...
Bueno, vamos a añadir otro matiz más: antes de que <icon s></icon> se convierta en <icon i></icon>, deben convertirse en personas <icon e></icon> Expuestas. Esto pasa cuando tienen el virus pero aún no pueden transmitirlo –infec*tadas* pero todavía no son infec*ciosas*.
...
Para el COVID-19, se estima que las personas son <icon e></icon> infectadas-pero-aún-no-infecciosas (expuestas) durante 3 días, *de promedio*.[^latent] ¿Qué pasa si añadimos eso a la simulación?
...
El R<sub>0</sub> para el COVID-19 se estima en 2.2,[^r0_covid] aunque un estudio *aún-no-finalizado* lo estima en 5.7(!) en Wuhan.[^r0_wuhan]
...
En nuestras simulaciones –*al inicio y de media*– una <icon i></icon> infecta a alguien cada 4 días, durante 10 días. «4 días» equivale a «10 días» dos veces y media. Esto significa que –*al incio y de media*– cada <icon i></icon> contagia a otras 2.5 personas. Por tanto, R<sub>0</sub> = 2.5. (matizaciones:[^r0_caveats_sim])
...
**Si sólo hubiera una lección que llevarse de esta información hasta ahora, sería ésta ** –es un diagrama extremadamente complejo así que, por favor, tómate tu tiempo para comprenderlo en su totalidad:
...
(Si consideras que R<sub>0</sub> o el resto de números de nuestras simulaciones son muy pequeños/grandes, ¡bienvenidos los cuestionamientos! Tendremos una “Plataforma” emos una «zona de juegos» al final de esta guía, donde podrás indicar tus *propios* números y simular lo que ocurre con ellos).

*Todas* las medidas de prevención y reacción para el COVID-19 que has oído –lavado de manos, distanciamiento social/físico, confinamientos, auto-aislamiento, cuarentenas y rastreo de contactos, mascarillas, incluso la «inmunidad de grupo»– *todas* hacen exactamente lo mismo:
...
Alrededor de 1 de cada 20 personas contagiadas por el COVID-19 necesitan ir a una UCI (Unidad de Cuidados Intensivos).[^icu_covid] En un país desarrollado como EEUU, hay una UCI por cada 3400 personas.[^icu_us] Por tanto, EEUU puede tratar 20 de cada 3400 personas contagiadas *simultáneamente* –o el 0.6% de la población.
...
(Muchos medios de comunicación y medios sociales informaron de que «se contagiará el 80%» *sin* el «SI NO HACEMOS NADA». El miedo se canalizó en clics, no en comprensión.)

###Escenario 1: Aplanar la curva / Inmunidad de grupo

El plan de «Aplanar la curva» ha sido promocionado por todas las organizaciones de sanidad pública, mientras que el plan original para la «inmunidad de grupo» del Reino Unido ha sido abucheado. Realmente se trata de *el mismo plan.* Pero el Reino Unido lo comunicó mal.[^yong]
...
Sin embargo, ambos planes adolecían de un muy grave error, literalmente.
...
[^handwashing]: «All eight eligible studies reported that handwashing lowered risks of respiratory infection, with risk reductions ranging from 6% to 44% [pooled value 24% (95% CI 6–40%)]». En aras de la simplicidad, en estas simulaciones hemos redondeado el valor hasta 25%. [Rabie, T. y Curtis, V.](https://onlinelibrary.wiley.com/doi/full/10.1111/j.1365-3156.2006.01568.x) Nota: tal y como este meta-análisis indica, la calidad de las medidas sobre el lavado de manos (al menos en los países desarrollados) son pésimas.
...
Ahora, simulemos lo que le pasa una epidemia de COVID-19 si al inicio de marzo de 2020 hubiésemos incrementado el lavado de manos y sólo *un poco* de distanciamiento social –de tal forma que R es menor pero aún está por encima de 1:
...
1. ¡Esto *reduce* los casos totales! **Incluso sin R < 1, la reducción de R salva vidas al reducir el 'exceso' sobre la inmunidad de grupo.** Muchas personas piensan que el «aplanar la curva» esparce los casos sin reducir el número total. Esto es imposible en los modelos de Introducción a la Epidemiología. Sin embargo, muchos pensaron que eso del «más del 80% se contagiará» era inevitable, sin importar lo que hicieran.

2. Debido a las medidas de acción y respuesta adicionales, el número de casos actual tendrá el pico *antes* de que se llegue a la inmunidad de grupo. De hecho, en esta simulación, el número total de casos solo excede *un poquito* la inmunidad de grupo –¡el plan del Reino Unido!–. Y ahí, con R < 1, puedes reducir eventualmente las medidas y el COVID-19 se mantendrá contenida! Bueno, excepto por un problema...
...
Eso no es «aplanar» la curva, es *despachurra* la curva. Por ejemplo, con un...
...
Pero espera... ¿Taiwan y Corea del Sur no han contenido *ya* el COVID-19? ¿Durante cuatro meses completos y *sin* confinamientos duraderos?
...
Para comprender cómo Taiwán y Corea del Sur han contenido el COVID-19, necesitamos comprender la cronología de una infección típica del COVID-19[^timeline]:
...
Esto se denomina **rastreo de contactos**. Es una vieja idea, que se usó a una escala sin precedentes para contener el ébola[^ebola], ¡y ahora es el núcleo central de la estrategia de contención del COVID-10 de Taiwán y Corea del Sur!
...
Tradicionalmente, los contactos se identifican mediante entrevistas personales, pero esas *por si solas* son muy lentas para la ventana de ~48 horas del COVID-19. Por eso los rastreadores de contactos necesitan ayuda, y soporte de –*NO* ser reemplazados por– aplicaciones de rastreo de contactos.
...
Así es como ganamos al COVID-19.
...
¿Qué pasa si R<sub>0</sub> es mucho mayor de lo que pensamos y las medidas y acciones anteriores, incluso con distanciamiento leve, *aún* no son suficientes para que R < 1?
...
Sin embargo, no estamos seguros del impacto de las mascarillas en el COVID-19 *en concreto*. En ciencia, solo se debe publicar un descubrimiento si se está al menos un 95% seguro de él. (...debe.[^replication]) Las mascarillas, al 1 de mayo de 2020, están por debajo de ese «95% seguro».
...
Sin embargo, las pandemias son como el póquer. **Apuesta sólo cuando estés seguro al 95% o terminarás perdiéndolo todo.** Como ha apuntado un reciente artículo sobre las mascarillas en el British Medical Journal,[^precautionary] *tenemos* que hacer análisis de coste/beneficio con la incertidumbre. Como éste:
...
Vale, esto no es una «situación» que podamos controlar, ¡pero será de ayuda! Algunos medios informan de que el verano no tendrá efecto con el COVID-19. Tienen solo la mitad de la razón: el verano no hará que R < 1, pero *reducirá* R.

Para el COVID-19, cada 1° Celsius (2.2° Fahrenheit) adicional hace que R disminuya un 1.2%.[^heat] La diferencia entre el verano y el invierno en la ciudad de Nueva York es de 15°C (60°F), así que el verano reducirá R en un 18%.
...
¡Pero no tendríamos que estar 2 meses cerrados / 1 abierto una y otra vez! Dado que R se reduce, solo tendríamos que tener uno o dos confinamientos «cortacircuitos» antes de que la vacuna esté disponible. (Recientemente, Singapur tuvo que hacerlo, «a pesar» de que tuvo controlado el COVID-19 durante 4 meses. No es un fracaso: esto *es* lo que el éxito requiere).
...
Sin mencionar todas las *otras* medidas, para reducir aún más R:
...
**Incluso en un escenario pesimista, *es* posible ganar al COVID-19 y proteger nuestra salud mental y financiera.** ¡Usa el confinamiento como un «botón de reinicio», mantén R < 1 con el aislamiento de casos + rastreo de contactos con privacidad + *al menos* mascarillas para todos... y la vida puede volver a cierta normalidad!
...
Te contagias del COVID-19 y te recuperas. O llegas a la vacuna del COVID-19. En cualquier caso, ahora eres inmune...

...*¿durante cuanto tiempo?*

* El pariente más cercano del COVID-19 es el SARS, cuyos supervivientes tuvieron 2 años de inmunidad.[^SARS immunity]
* Los conarovirus que causan el resfriado común te dan 8 meses de inmunidad.[^cold immunity]
* Hay informes de personas recuperadas del COVID-19 que luego han vuelto a dar positivo pero no está claro si han dado falsos positivos.[^unclear]
* Y un estudio *aún no revisado por pares* con monos muestran inmunidad al coronavirus del COVID-19 durante al menos 28 días.[^monkeys]

Pero para el COVID-19 *en humanos*, al 1 de mayo de 2020, la gran incógnita es «hasta cuándo».
...
Ahora, vamos a simular un brote del COVID-19, durante 10 años, sin intervenciones... *si la inmunidad sólo durase un año:*
...
Este «simulador de vuelo de epidemias» básico nos ha enseñado mucho. Nos ha permitido encontrar respuestas a dudas que teníamos sobre los pasados meses, los próximos meses y los próximos años.
...
**Para todos:** Respeta el confinamiento para que podamos pasar de la Fase 1 rápidamente. Mantén limpias esas manos. Fabrica tus propias mascarillas. Descarga una aplicación de rastreo de contactos *que proteja la privacidad* cuando estén disponibles el próximo mes. Mantente sano ¡física y mentalmente!
